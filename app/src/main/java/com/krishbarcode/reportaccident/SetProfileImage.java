                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                          ...
                          //  @SuppressWarnings("VisibleForTests")
                            //Upload upload = new Upload(firebaseUser.getUid(), taskSnapshot.getDownloadUrl().toString());
...
//        imageView.buildDrawingCache();
        ...
        //getting the storage reference
        StorageReference sRef = storageReference.child(vehno +"/"+ firebaseUser.getUid() + "." + getFileExtension(filePath));
        //String stoname = Constants.STORAGE_PATH_UPLOADS +firebaseUser.getUid();
